...
const getPairedSound = (char) => getPairedSound(firstConsonant || initialChar || char) || char;

// ฟังก์ชันตรวจสอบและจำกัดให้รับเฉพาะ 1 พยางค์ (พยัญชนะต้น/ควบกล้ำ + สระ)
const validateSingleSyllable = (text) => {
  if (!text) return "";
  // ตัดช่องว่างและตัดเหลือความยาวคำไม่เกิน 1 พยางค์ (ไม่เกิน 5 อักขระ)
